...
src/agent/agent_v2.py          # Improved ReAct Agent v2
src/tools/basic_tools.py       # Tool definitions
src/run_agent.py               # Run Agent v1
src/run_agent_v2.py            # Run Agent v2
src/compare_v1_v2.py           # Compare Agent v1 and Agent v2
...
| Tool           | Purpose                                      |
| -------------- | -------------------------------------------- |
| `order_lookup` | Look up order status and total amount        |
| `shipping_fee` | Calculate shipping fee by package weight     |
